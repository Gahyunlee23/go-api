    ...
    "paths": {
        ...
        "/file-inspections/": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/models.FileInspection"
                            }
                        }
                    },
                    "400": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "File Inspection data",
                        "name": "FileInspection",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/file-inspections/{id}": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "integer",
                        "description": "File Inspection ID",
                        "name": "id",
                        "in": "path",
                        "required": true
                    }
                ...
                "responses": {
                    ...
                    "404": {
                        "description": "Entity '%Entity Inspection' with ID '%Given ID' not found",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
            ...
            "put": {
                ...
                "parameters": [
                    {
                        "type": "integer",
                        "description": "FileInspection ID",
                        "name": "id",
                        "in": "path",
                        "required": true
                    },
                    {
                        "description": "Updated File Inspection data",
                        "name": "product",
                        "in": "body",
                        "required": true,
                        "schema": {
            ...
            "delete": {
                ...
                "responses": {
                    "200": {
                        "description": "File Inspection deleted successfully",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/proofs/{id}": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Updated Proof data",
                        "name": "Proof",
                        "in": "body",
                        "required": true,
                        "schema": {
