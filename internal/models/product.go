...
type Product struct {
	...
	Part                 []ProductPart    `gorm:"many2many:product_product_part;"`
	Proof                []Proof          `gorm:"many2many:product_proof;"`
	ProductionTime       []ProductionTime `gorm:"many2many:product_production_time;"`
	FileType             []FileType       `gorm:"many2many:product_file_type;"`
	FileInspection       []FileInspection `gorm:"many2many:product_file_inspection;"`
}
